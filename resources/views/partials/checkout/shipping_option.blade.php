    ...
    <div class="p-6">
        ...
        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
            ...
            <div>
                ...
                <label class="flex items-center justify-between p-4 text-sm font-medium border border-gray-100 rounded-lg shadow-sm cursor-pointer peer-checked:border-stone-500 hover:bg-gray-50 peer-checked:ring-1 peer-checked:ring-stone-500" for="{{ $option->getIdentifier() }}">
                    <p>
        ...
        <div class="mt-6 text-right">
            <button class="px-5 py-3 text-sm font-medium text-white bg-stone-600 rounded-lg hover:bg-stone-500" type="submit" wire:key="shipping_submit_btn">
