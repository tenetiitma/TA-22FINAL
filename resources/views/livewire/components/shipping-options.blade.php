<form wire:submit.prevent="save" class="border rounded shadow-lg">
    ...
    <div class="p-4 border-t">
        ...
        <label class="flex items-center w-full cursor-pointer" wire:key="shipping_option_{{ $option->getIdentifier() }}">
    ...
    <div class="flex justify-end w-full p-4 bg-gray-100">
        <div>
            <button type="submit" wire:key="submit_btn" class="px-5 py-3 font-medium text-white bg-stone-600 rounded-lg hover:bg-stone-500">
                Jätka
            </button>
        </div>
    </div>
